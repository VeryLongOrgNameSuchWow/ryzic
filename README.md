...
- Persistent now-playing controller embed in the channel where `/play` was last used, with pause/resume · skip · stop buttons that drive the same code paths as the slash commands.
